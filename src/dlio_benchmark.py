...
class DLIOBenchmark(object):
    ...
    def _eval(self, epoch):
        ...
        for batch in loader.next():
            end_time = time()
            perftrace.event_complete(f"eval_epoch_{epoch}_step_{step}", "DLIO_BENCHMARK", start_time, end_time - start_time)
    ...
    def _train(self, epoch):
        ...
        for batch in loader.next():
            end_time = time()
            perftrace.event_complete(f"train_epoch_{epoch}_step_{block_step}", "DLIO_BENCHMARK", start_time, end_time - start_time)
